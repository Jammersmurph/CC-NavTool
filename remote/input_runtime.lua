...
local injected = table.concat({
  ...
  '    writeAt(3,8,"Maintenance",colors.lightGray)',
  '    fill(3,10,18,3,colors.gray); writeAt(8,11,"UPDATE",colors.white,colors.gray)',
  '    fill(24,10,18,3,colors.red); writeAt(28,11,"UNINSTALL",colors.white,colors.red)',
  ...
  '      elseif a==keys.two then action="refresh"',
  '      elseif a==keys.three then action="strength"',
  '      elseif a==keys.u then action="update"',
  '      elseif a==keys.d then action="uninstall" end',
  '    elseif event=="mouse_click" then',
  '      if b>=3 and b<=20 and c>=10 and c<=12 then action="update"',
  '      elseif b>=24 and b<=41 and c>=10 and c<=12 then action="uninstall" end',
  '    end',
  ...
  '    elseif action=="refresh" then data.preferences.autoRefresh=not (data.preferences.autoRefresh~=false)',
