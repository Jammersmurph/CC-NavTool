...
local function loadConfig()
  ...
  if type(config.navigation) == "table" and (config.navigation.finalVerticalRadius == nil or tonumber(config.navigation.finalVerticalRadius) == 10 or tonumber(config.navigation.finalVerticalRadius) == 25) then
    config.navigation.finalVerticalRadius = 15
    config._migrated = true
  end
